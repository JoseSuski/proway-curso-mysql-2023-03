...
-- Consultar o nome dos produtos do mercado uma única vez, ou seja, o nome não se repita na consulta
...
-- Consultar o menor valor dos produtos unitários por categorias
SELECT
    categoria AS "Categoria",
    MIN(preco_unitario)
    FROM mercadorias
...
SELECT nome, preco_unitario * estoque "Preço" FROM mercadorias;
...
-- Consultar número de produtos por categoria
SELECT
    categoria,
    COUNT(*)
    FROM mercadorias
